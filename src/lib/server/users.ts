...
export async function upsertUser(
	...
	await db.execute(
		`INSERT INTO users (id, email, name, avatar, login_type, role, last_login, country)
		...
		[claims.sub, claims.email, claims.name ?? '', claims.picture ?? '', loginType, role, country ?? null]
	);
